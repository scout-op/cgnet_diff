...
checkpoint_config = dict(interval=10, save_last=True)

work_dir = '/mnt/tf-mdriver-jfs/exps/lixiangjie/roadnet/data_copy/cg/fg/work_dirs/cgnet_baseline'
