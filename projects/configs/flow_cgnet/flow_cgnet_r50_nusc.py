...
train_pipeline = [
    ...
    dict(type='DefaultFormatBundle3D', class_names=['centerline']),
...
test_pipeline = [
    ...
    dict(
        ...
        flip=False,
        transforms=[
            dict(type='DefaultFormatBundle3D', class_names=['centerline'], with_label=False),
...
# 工作目录
work_dir = 'work_dirs/flow_cgnet_r50_nusc'
