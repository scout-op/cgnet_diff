...
class GeometryKernelAttention(BaseModule):
    ...
    def init_weights(self):
        ...
        # NOTE: GeometryKernelAttention currently does not use an output projection.
        # Keep initialization safe when output_proj is disabled.
    ...
    def forward(self,
        ...
        output = GeometricKernelAttentionFunc.apply(
            value, spatial_shapes, level_start_index, sampling_locations.contiguous(), attention_weights, im2col_step
        )
